...
function TodayUpdate() {
    ...
    window.baseTools.GetSentimentDailyReport(parameters, function (result) {
        ...
        if (result && result.Result) {
            ...
            $todaynegative.attr({ "class": "negative", "data-text": negCount, "data-percent": negPercent, "data-fgcolor": "#ff5f40", "data-bgcolor": "#cacaca" });
            var todaynegativeHtml = $todaynegative.circliful();
            $("#today_negative").html(todaynegativeHtml)


            var $todayupdate = $(circlHtml);
            $todayupdate.attr({ "class": "update", "data-text": posCount, "data-percent": posPercent, "data-fgcolor": "#84c396", "data-bgcolor": "#cacaca" });
